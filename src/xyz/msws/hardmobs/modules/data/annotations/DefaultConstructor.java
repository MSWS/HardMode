package xyz.msws.hardmobs.modules.data.annotations;
...
/**
 * @deprecated Tried to implement this into the project, didn't get it to work
 *             without making it into a jar and use it as extra dependency and
 *             making an extra dependency just for an Annotation Processor seems
 *             a bit over kill
 *
 * @author Gijs de Jong
 */
