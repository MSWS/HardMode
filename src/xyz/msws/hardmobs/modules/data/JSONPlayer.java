...
/**
 * Really simple JSON wrapper for {@link org.bukkit.entity.Player} Used for
 * {@link com.scorch.core.modules.communication.NetworkEvent}s
 */
public class JSONPlayer {
	...
	public static JSONPlayer fromPlayer(Player player) {
		return new JSONPlayer(player.getUniqueId(), player.getName(), player.getHealth(),
