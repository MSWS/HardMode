package xyz.msws.hardmobs.inventory;
...
import xyz.msws.hardmobs.data.CData;
import xyz.msws.hardmobs.utils.Callback;
import xyz.msws.hardmobs.utils.MSG;

@SerializableAs("CItem")
public class CItem implements ConfigurationSerializable, CData {
